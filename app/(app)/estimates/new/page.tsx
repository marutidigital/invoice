...
export default function EstimateTemplatePicker() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900">Choose a template for your estimate</h1>
        <p className="text-slate-500 text-sm mt-1">Select from our 35 professionally designed templates to style your quote or estimate.</p>
      </div>
